...
@SourceType(value = "AvalaraAvataxARP", label = "AvalaraAvatax",uiConfig = "avalaraavatax-layout.json")
public class AvalaraAvataxConf extends AbstractArpConf<AvalaraAvataxConf> {
  private static final String ARP_FILENAME = "arp/implementation/avalaraavatax-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.avalaraavatax.AvalaraAvataxDriver";
